...
{
    public class YML : MainContractor.Repository
    {
        ...
        public async Task<List<YML.yml_catalogShopOffer>> GetOffers(string url)
        {
            YML.yml_catalog result = new YML.yml_catalog();
            await Task.Run(() =>
            {
